...
#ifndef __PANSI_h_h__
#define __PANSI_h_h__
...
typedef struct  tagPS_USERITEM
    {
    unsigned char computername[ 16 ];
    unsigned char regname[ 20 ];
...
typedef struct  tagEN_ssystem
    ...
    PS_TIME fftime[ 4 ];
    PS_TIME ggtime[ 4 ];
    unsigned char HomePage[ 80 ];
    }	EN_ssystem;

typedef struct  tagEN_sstation
    {
    unsigned char name[ 21 ];
    unsigned char protocol[ 21 ];
    unsigned char addr1[ 16 ];
...
typedef struct  tagENEVENT
    ...
    short station;
    short point;
    unsigned char note[ 21 ];
    unsigned char optor[ 20 ];
    unsigned char flag;
    }	ENEVENT;
...
int RPC_SavePageFile( 
    ...
    /* [string][in] */ unsigned char __RPC_FAR *regname);
...
int RPC_GetStationStruct( 
    /* [size_is][out] */ unsigned char __RPC_FAR pstations[  ],
    /* [in] */ int size);

int RPC_GetYXStruct( 
    /* [size_is][out] */ unsigned char __RPC_FAR pyyx[  ],
    /* [in] */ int size,
    /* [in] */ int station);

int RPC_GetYCStruct( 
    /* [size_is][out] */ unsigned char __RPC_FAR pyyc[  ],
    /* [in] */ int size,
    /* [in] */ int station);

int RPC_GetYDStruct( 
    /* [size_is][out] */ unsigned char __RPC_FAR pyyd[  ],
    /* [in] */ int size,
    /* [in] */ int station);

int RPC_GetYTStruct( 
    /* [size_is][out] */ unsigned char __RPC_FAR pyyt[  ],
    /* [in] */ int size,
    /* [in] */ int station);

int RPC_GetExprStruct( 
    /* [size_is][out] */ unsigned char __RPC_FAR expr[  ],
    /* [in] */ int size,
    /* [in] */ int vtype);
...
int RPC_GetNewEvents( 
    /* [size_is][out][in] */ unsigned char __RPC_FAR pEvents[  ],
    /* [in] */ int size);
...
int RPC_GetDayYXData( 
    /* [string][in] */ unsigned char __RPC_FAR *datetime,
    /* [size_is][in] */ long __RPC_FAR pIDs[  ],
    /* [size_is][out] */ PS_rt_yx __RPC_FAR data[  ],
    /* [in] */ int n);
...
int RPC_LoadEventBase( 
    /* [size_is][out] */ unsigned char __RPC_FAR pEvents[  ],
    /* [in] */ int size,
    /* [in] */ PS_DATE __RPC_FAR *pDate);
...
float RPC_EvaluateExpression( 
    /* [size_is][in] */ unsigned char __RPC_FAR pExpr[  ],
    /* [out] */ int __RPC_FAR *errcode);

int RPC_GetRecordNum( 
    /* [in] */ long varID,
    /* [string][in] */ unsigned char __RPC_FAR *datetime0,
    /* [string][in] */ unsigned char __RPC_FAR *datetime1);
...
int RPC_LockPage( 
    /* [string][in] */ unsigned char __RPC_FAR *pagefile,
    /* [string][in] */ unsigned char __RPC_FAR *regname);
...
int RPC_InsertEvent( 
    /* [size_is][in] */ unsigned char __RPC_FAR pEvents[  ],
    /* [in] */ int size);
...
extern RPC_IF_HANDLE pansi_v1_0_c_ifspec;
extern RPC_IF_HANDLE pansi_v1_0_s_ifspec;
